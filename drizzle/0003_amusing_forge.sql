...
CREATE INDEX `wishlists_userId_idx` ON `wishlists` (`user_id`);--> statement-breakpoint
CREATE INDEX `wishlists_user_archived_idx` ON `wishlists` (`user_id`,`archived`);--> statement-breakpoint
CREATE INDEX `wishlists_companyId_idx` ON `wishlists` (`company_id`);--> statement-breakpoint
...
CREATE INDEX `applications_companyId_idx` ON `applications` (`company_id`);